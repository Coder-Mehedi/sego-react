                    ...
                    <table className="table items-table table-responsive-md">
                      <tbody>
                        ...
                        <tr className="alert alert-dismissible border-0">
                          ...
                          <td>
                            <h4 className="my-0 text-black font-w600">1x</h4>
                          </td>
                          <td>
                        ...
                        <tr className="alert alert-dismissible border-0">
                          ...
                          <td>
                            <h4 className="my-0 text-black font-w600">3x</h4>
                          </td>
                          <td>
                            <h4 className="my-0 text-black font-w600">$14.99</h4>
                          </td>
                          <td className="d-md-none d-lg-table-cell">
            ...
            <div className="col-xl-12 col-sm-6">
              <div className="card">
                ...
                <div className="card-footer d-flex align-items-center gradient-bg">
                  ...
                  <span className="text-white font-w600">6 The Avenue, London EC50 4GN</span>
                </div>
              </div>
            </div>
            <div className="col-xl-12 col-sm-6">
