            ...
            <Tab.Pane eventKey="monthly" className="tab-pane fade" id="Monthly">
              <div className="row align-items-center">	
                ...
                <div className="col-sm-6 mb-sm-0 mb-3 text-center">
                  ...
                  <Link to="post-details" className="btn btn-primary light btn-rounded">More Details</Link>
                </div>
              </div>
              <div className="row">
      ...
      <div className="card">	
        <div className="card-header d-sm-flex d-block pb-0 border-0">
          ...
          <Dropdown className="dropdown mt-sm-0 mt-3">
            <Dropdown.Toggle type="button" className="btn btn-primary light btn-rounded dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
              Monthly
            </Dropdown.Toggle>
            <Dropdown.Menu className="dropdown-menu dropdown-menu-right">
              <Dropdown.Item className="dropdown-item" to="/">Link 1</Dropdown.Item>
              <Dropdown.Item className="dropdown-item" to="/">Link 2</Dropdown.Item>
              <Dropdown.Item className="dropdown-item" to="/">Link 3</Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
        </div>
          ...
          <Tab.Container defaultActiveKey="all-food">
            <div className="d-flex flex-wrap mb-4">
              ...
              <div className="card-action revenue-tabs">
                <Nav as="ul" className="nav nav-tabs" role="tablist">
                  <Nav.Item as="li" className="nav-item">
                    <Nav.Link className="nav-link" data-toggle="tab" eventKey="all-food" role="tab">
                      All Food
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item as="li" className="nav-item">
                    <Nav.Link className="nav-link" data-toggle="tab" eventKey="food" role="tab">
                      Food
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item as="li" className="nav-item">
                    <Nav.Link className="nav-link" data-toggle="tab" eventKey="beverages" role="tab">
                      Beverages
                    </Nav.Link>
                  </Nav.Item>
                </Nav>
            ...
            <Tab.Content className="tab-content" id="myTabContent">
              <Tab.Pane className="tab-pane fade" eventKey="all-food" id="user" role="tabpanel">
                <ActivityLineChart />
              </Tab.Pane>
              <Tab.Pane className="tab-pane fade" eventKey="food" id="user" role="tabpanel">
              <ActivityLineChart2 />
              </Tab.Pane>
              <Tab.Pane className="tab-pane fade" eventKey="beverages" id="user" role="tabpanel">
              <ActivityLineChart3 />
              </Tab.Pane>
            </Tab.Content>
            </Tab.Container>
        ...
        <div className="col-xl-12">	
          <div className="card">
            <Tab.Container defaultActiveKey="monthly" >
              ...
              <Tab.Content className="tab-content" id="myTabContent">
                <Tab.Pane className="tab-pane fade" eventKey="monthly" id="tab1">
                  <TimeLineChart />
                </Tab.Pane>
                <Tab.Pane className="tab-pane fade" eventKey="weekly" id="tab2">
                  <TimeLineChart2 />
                </Tab.Pane>
                <Tab.Pane className="tab-pane fade" eventKey="today" id="tab3">
                <TimeLineChart3 />
                </Tab.Pane>
              </Tab.Content>
            </div>
          ...
          <div className="card trending-menus">
            ...
            <div className="card-body">
              ...
              <div className="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">
                ...
                <img src={menu10} alt="menu10" width={60} className="rounded" />
              </div>
              <div className="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">
